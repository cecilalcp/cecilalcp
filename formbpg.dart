...
class FormbpgPage extends StatefulWidget {
  @override
  _FormbpgPageState createState() => _FormbpgPageState();
}

class _FormbpgPageState extends State<FormbpgPage> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  final TextEditingController _nameController = TextEditingController();
  final TextEditingController _contactController = TextEditingController();
  final TextEditingController _addressController = TextEditingController();
  final TextEditingController _quantityController = TextEditingController();
  String _selectedProduct = 'Bawang Putih Grosir';
  String _selectedPrice = 'Rp 24.000';
  int _totalPrice = 0;
